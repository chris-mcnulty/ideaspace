...
export default function StarshipParticipant() {
  ...
  useEffect(() => {
    if (org && space) {
      ...
      document.title = "Nebula - Starship | The Synozur Alliance";
    }
  }, [org, space]);
    ...
    <div className="flex min-h-screen flex-col">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">Starship</p>
            </div>
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 p-3 sm:p-6 focus:outline-none">
        <div className="mx-auto max-w-7xl">
          <StarshipModule spaceId={params.space} />
        </div>
      </main>
    </div>
  );
