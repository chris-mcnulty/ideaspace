...
export function SynozurAppSwitcher({ currentApp = "nebula", forceDark = false }: SynozurAppSwitcherProps) {
  ...
  const triggerClasses = forceDark
    ...
    : `text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-white ${open ? "bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white" : ""}`;
  ...
  const descriptionClasses = forceDark
    ? "text-gray-500"
    : "text-gray-500 dark:text-gray-500";

  const currentBadgeClasses = forceDark
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {isCurrent && (
                        <span className={`text-[9px] font-bold tracking-wider uppercase px-1.5 py-0.5 rounded-full ${currentBadgeClasses}`}>
                          Current
                        </span>
                      )}
                    </div>
                    ...
                    <p className={`text-[11px] leading-snug mt-0.5 ${descriptionClasses}`}>
                      {app.description}
                    </p>
                  </div>
                  {!isCurrent && (
